    ...
    return (
        <>
            <section className='relative h-auto w-auto flex flex-col'>
                <section className='bg-theme clip-path h-[90vh] lg:h-[80vh] md:h-[70vh] sm:h-[60vh] w-auto absolute top-0 left-0 right-0 opacity-100 z-10'>
                </section>
                <section className='relative opacity-100 z-20 grid items-center justify-items-center nike-container' >
                    ...
                    <section className='' >
                        <Image className='transitions-theme w-auto h-[45vh] lg:h-[35vh] md:h-[31vh] sm:h-[21vh] xsm:h-[19vh] -rotate-[25deg] hover:rotate-0 cursor-pointer object-fill' src={img} alt="hero" priority />
                    </section>
                </section>
            </section>
        </>
